...
local function onMotion(_, address, relX, relY, relZ, entity)
    ...
    --if not lock and ((relX >= -3 and relX < 0 and relZ > 0 and relZ < 2 and relY > -2 and relY < 5) or (relX <= 5 and relX < 0 and relZ >= -5 and relZ < 0)) then
    
    --this ones for the north
    if not lock and ((relX >= -3 and relX < 0 and relZ > 0 and relZ < 2 and relY > -2 and relY < 5) or (relX < 0 and relX <= -3 and relZ > 0 and relZ <= 5)) then    
